...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="border-t border-accent-800 bg-neutral-900" ref={overviewRef}>
        <main>
          {/* Overview */}
          ...
          <div className="container relative grid max-w-screen-xl gap-8 py-12 mx-auto md:grid-cols-2 bg-neutral-900/50">
            ...
            <div>
              ...
              <div className="max-w-lg text-neutral-300">
                <p>
                  The <span className="text-orange-400">Vendetta token</span> is the lifeblood of
                  our ecosystem and the native token of the Vendetta ecosystem. It is our{" "}
                ...
                {showInfo && (
                  <p>
                    ...
                    Making sure we have enough tokens in the right hands is key to our success.
                  </p>
                )}
              </div>
            </div>
            ...
            <>
              ...
              <div className="container relative grid max-w-screen-xl gap-8 py-12 mx-auto md:grid-cols-2 bg-neutral-900/50">
                <div>
                  ...
                  <div className="max-w-lg text-neutral-300">
                    <p>
                      <span className="text-orange-400">Live by the gun, die by the gun… </span>
                      Chalk River Territory is a stunning Wild West Metaverse.
                    </p>
                    <br />
                    <p>
                      Ever since gold was discovered, the territory has been overrun with every type
                      of hired gun, wildcatter, card cheat, and carpetbagger to ever roam the West.
                    </p>
                    <br />
                    <ul className="text-left list-disc">
                    ...
                    <br />
                    <p>
                      The Chalk River metaverse is loaded with natural resources for those brave
                      enough to blast them out. The town of Chalk River was erected shortly after
                      the discovery of the mine. The local inhabitants created a guild to protect
                      the town and themselves against the hostile forces hellbent on taking over the
                      town and the mine.
                    </p>
                    <br />
                    <p>
                      To survive in this territory, you need to be tough and you need to know how to
                      shoot. Often one is the key to the other.
                    </p>
                  </div>
                </div>
                {/* <video
              ...
              <div className="container relative grid max-w-screen-xl gap-8 py-12 mx-auto md:grid-cols-2 bg-neutral-900/50">
                ...
                <div>
                  ...
                  <div className="max-w-lg text-neutral-300">
                    <p>
                      Vendetta Games was created to build games for the Vendetta community. Vendetta
                      Games takes a 365 degree approach to every games we build. We start by trying
                      to understand what reality is in each metaverse game we create. Drawing from
                      elements unique to each project allows us to make games that are fun to play
              ...
              <div className="container relative grid max-w-screen-xl gap-8 py-12 mx-auto md:grid-cols-2 bg-neutral-900/50">
                <div>
                  ...
                  <div className="max-w-lg text-neutral-300">
                    <p>
                      The Vendetta Guild is the heart and soul of the ecosystem. It offers one of
                      the most attractive scholarship opportunities in the metaverse. We work with
                      the best developers to create a lending platform that makes it easy for the
                      player and safe for the asset owner. The Vendetta Scholarship Program is
              ...
              <div className="container relative grid max-w-screen-xl gap-8 py-12 mx-auto md:grid-cols-2 bg-neutral-900/50">
                ...
                <div>
                  ...
                  <div className="max-w-lg text-neutral-300">
                    <p>
                      The Vendetta Launchpad propels the next generation of WEB3 projects into the
                      stratosphere via an open application for anyone with an idea for an NFT game
                      or dApp. We will be assessing all applications and choosing 50 of them to
                    ...
                    <ul className="text-left list-disc">
                      ...
                      <li>
                        One wallet/access point to all games (meaning any user from any game can
                        join yours)
                      </li>
                      <li>High volume marketplace with advanced features</li>
                      <li>
                        24/7 support with NFT creations, game development, and community reach.
                      </li>
                      <li>
                        Access to your own gas-free, non-crypto NFT engine that allows you to create
                        any NFT with the metadata you choose called Agora.
                      </li>
                      <li>Technical and development support</li>
                      <li>Introductions to our gaming development partners</li>
                      <li>
                        Marketing, initial NFT sale rounds, promotions, and access to our large
                        community.
                      </li>
                    </ul>
                    <br />
                    <p>
                      Vendetta is now at a stage ready to expand to more games, more users, and more

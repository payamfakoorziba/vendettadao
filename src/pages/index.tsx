...
export default function Home() {
  ...
  return (
    <>
      <Hero>
        <h1
          className="font-serif font-bold tracking-tight text-center text-7xl md:text-8xl lg:text-9xl text-accent-300"
        >
          VENDETTA DAO
        </h1>
      ...
      >
        <main>
          {/* Overview */}
          <div
            className="container relative grid max-w-screen-xl gap-8 py-12 mx-auto md:grid-cols-2"
          >
            <div>
              ...
              <div>
                ...
                <div className="max-w-lg text-neutral-300">
                  ...
                  <ul className="text-left list-disc">
                    ...
                    <li>One wallet/access point to all games (meaning any user from any game can join yours)</li>
                    <li>High volume marketplace with advanced features</li>
                    <li>24/7 support with NFT creations, game development, and community reach.</li>
                    <li>Access to your own  gas-free, non-crypto NFT engine that allows you to create any NFT with the metadata you choose called Agora.</li>
                    <li>Technical and development support</li>
                    <li>Introductions to our gaming development partners</li>
                    <li>Marketing, initial NFT sale rounds, promotions, and access to our large community.</li>
                  </ul>
                  <br />
                  <p>
